...
def search(cell_start: tuple, cell_goal: tuple) -> None:
    global CSpaceMap

    cell_s = cell_start  # Initial cell
    cell_g = cell_goal  # Goal cell
    ...
    for cell_a, action, cell_b in get_sequence(sg):
        ...
        pose_stamped.pose.position = Point(float(cell_b[0]), float(cell_b[1]), 0)
...
if __name__ == '__main__':
    ...
    rospy.Suscriber('path_points', Path, search)
